...
class TVGuide(xbmcgui.WindowXML):
    ...
    def _showContextMenu(self, program):
        ...
        if buttonClicked == PopupMenu.C_POPUP_REMIND:
            ...
            xbmc.executebuiltin('RunAddon(plugin.video.ustvnow.tva)')

        elif buttonClicked == PopupMenu.C_POPUP_LIBTV:
            xbmc.executebuiltin('Addon.OpenSettings(plugin.video.ustvnow.tva)')
			
        elif buttonClicked == PopupMenu.C_POPUP_VIDEOADDONS:
            xbmc.executebuiltin('Addon.OpenSettings(script.ustvnow.plus.guide)')
