...
def main():
  ...
  for repo_dir in dirs:
    try:
      ...
      repo_xml += "      path=\"https://raw.githubusercontent.com/netxeon/AddOnRepo/master/" + get_repo_value(repo_dir, "name") + "/" + get_repo_value(repo_dir, "id") + "/" + get_repo_value(repo_dir, "id") + "-" + get_repo_value(repo_dir, "version") + ".zip" + "\"/>\n"
